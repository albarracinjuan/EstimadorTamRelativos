...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            response.append(OperadorFunciones.redondear(calculador1.getLstRangosTamanioRelativo().get(0), 4));
            response.append("</td>");
            response.append("<td class=\"tg-yw4l\">");
            response.append(OperadorFunciones.redondear(calculador1.getLstRangosTamanioRelativo().get(1), 4));
            response.append("</td>");
            response.append("<td class=\"tg-yw4l\">");
            response.append(OperadorFunciones.redondear(calculador1.getLstRangosTamanioRelativo().get(2), 4));
            response.append("</td>");
            response.append("<td class=\"tg-yw4l\">");
            response.append(OperadorFunciones.redondear(calculador1.getLstRangosTamanioRelativo().get(3), 4));
            response.append("</td>");
            response.append("<td class=\"tg-yw4l\">");
            response.append(OperadorFunciones.redondear(calculador1.getLstRangosTamanioRelativo().get(4), 4));
            response.append("</td>");
            response.append("</tr>");
            response.append("<tr>");
            ...
            response.append("<td class=\"tg-yw4l\">");
            response.append(OperadorFunciones.redondear(calculador2.getLstRangosTamanioRelativo().get(0), 4));
            response.append("</td>");
            response.append("<td class=\"tg-yw4l\">");
            response.append(OperadorFunciones.redondear(calculador2.getLstRangosTamanioRelativo().get(1), 4));
            response.append("</td>");
            response.append("<td class=\"tg-yw4l\">");
            response.append(OperadorFunciones.redondear(calculador2.getLstRangosTamanioRelativo().get(2), 4));
            response.append("</td>");
            response.append("<td class=\"tg-yw4l\">");
            response.append(OperadorFunciones.redondear(calculador2.getLstRangosTamanioRelativo().get(3), 4));
            response.append("</td>");
            response.append("<td class=\"tg-yw4l\">");
            response.append(OperadorFunciones.redondear(calculador2.getLstRangosTamanioRelativo().get(4), 4));
            response.append("</td>");
            response.append("</tr>");
